  ...
  return (
    <div className="bg-transparent flex justify-center items-center h-full">
      ...
      >
        ...
        <div className="relative z-10 px-6 py-20 sm:py-28 lg:py-32 text-center text-white">
          ...
          <div className="my-8">
            ...
            >
              <i className="fab fa-whatsapp text-[#25d366] text-[180px] inline-block transition-transform duration-300 ease-in-out hover:scale-110"></i>
            </a>
          </div>
